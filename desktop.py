...
fans_quantity = int(input("How many fans do you have? "))
fans = []
for i in range(fans_quantity):
    fans_name = input(f"What is your fan? {i+1}: ")
    fans.append(fans_name)
